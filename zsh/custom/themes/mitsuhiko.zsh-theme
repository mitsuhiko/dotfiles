...
function _mitsuhiko_precmd() {
  ...
  function async_prompt() {
    ...
    #
    echo -n $'\n'$_MITSUHIKO_PROMPT$' '$(git_super_status)$(hg_prompt_info)$(virtualenv_prompt_info)$(multirust_prompt_info)$(idasen_control_prompt_info)$(transportstatus_prompt_info) > $_MITSUHIKO_ASYNC_PROMPT_FN
